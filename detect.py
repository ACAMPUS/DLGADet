...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'D:\dataset\实验记录\38\exp40\weights\best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=r'D:\dataset\data\new_dataset\annotations\mytt100_origion\test\images', help='file/dir/URL/glob, 0 for webcam')
