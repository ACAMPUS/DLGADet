...
class TT100K2COCO:
    ...
    def class_statistics(self):
        ...
        print(type_list)  # 保留的100个类别
        # 保存结果
        json_name = os.path.join(parent_path, 'statistics_new.json')
    ...
    def original_datasets2object_datasets(self):
        ...
        with open(os.path.join(parent_path, 'statistics_new.json')) as select_json:
        ...
        for image_id in images_dic:
            ...
            if len(obj_list)==0:
                miss_box+=1
                if 'train' in image_path:
                    print('train have no box: ',image_path)
                elif 'test' in image_path:
                    print('test have no box: ',image_path)
                else:
                    print('val have no box: ',image_path)
            for anno_dic in obj_list:
                if  not anno_dic['category'] in label:
                    continue
                ...
                dataset['annotations'].append({
                    ...
                    'category_id': int(label[label_key]),
                    'id': obj_id,
    ...
    def coco_json2yolo_txt(self, class_json,train_val_test_json_path_pre,ana_txt_save_path):
        ...
        json_file = os.path.join(
            train_val_test_json_path_pre+'/%s.json' % class_json)  # COCO Object Instance 类型的标注
        # ana_txt_save_path = 'D:/jinxData/TT100K/data/dataset/annotations/train'  # 保存的路径
        ana_txt_save_path = os.path.join(ana_txt_save_path, class_json)  # 保存的路径
        ...
        for img in tqdm(data['images']):
            ...
            f_txt = open(os.path.join(ana_txt_save_path,'labels', ana_txt_name), 'w')
    ...
    def divide_TrainValTest(self, label_dir, target,sources):
        '''
        创建文件路径
        :param source: 源文件位置
        :param target: 目标文件位置
        ...
        for label in label_list:
            file_name=label.split('.')[0]+ '.jpg'
            image_list.append(file_name)
        # sources=[r'D:\dataset\data\train',r'D:\dataset\data\test',r'D:\dataset\data\other']
    ...
    def divide_TrainValTestForDfg(self, label_dir, target,sources):
        '''
        创建文件路径
        :param source: 源文件位置
        :param target: 目标文件位置
        ...
        for label in label_list:
            file_name=label.split('.')[0]+ '.jpg'
            image_list.append(file_name)
        img_list=os.listdir(sources)
        for file in tqdm(img_list):
            if file in image_list:
                shutil.copyfile(os.path.join(sources, file), os.path.join(target, file))
...
if __name__ == '__main__':
    ...
    # train_val_test_json_path_pre=r'/root/autodl-tmp/datasets/tt100k_2021/mytt100'
    # # parent_path=r''
    # ana_txt_save_path=r'/root/autodl-tmp/datasets/tt100k_2021/mytt100'
    # tt100k.original_datasets2object_datasets()
    # tt100k.coco_json2yolo_txt('test',train_val_test_json_path_pre,ana_txt_save_path)
    # tt100k.divide_TrainValTest(r'D:\dataset\data\my_tt100k\train\labels', r'D:\dataset\data\my_tt100k\train\images')

    # local
    # sources=[r'D:\dataset\data\train',r'D:\dataset\data\test',r'D:\dataset\data\other']
    # tt100k.divide_TrainValTest(r'D:\dataset\data\new_dataset\annotations\mytt100\train\labels', r'D:\dataset\data\new_dataset\annotations\mytt100\train\images',sources)
    # tt100k.divide_TrainValTest(r'D:\dataset\data\new_dataset\annotations\mytt100\test\labels', r'D:\dataset\data\new_dataset\annotations\mytt100\test\images',sources)


    # server
    # sources=['/root/autodl-tmp/datasets/tt100k_2021/train','/root/autodl-tmp/datasets/tt100k_2021/test','/root/autodl-tmp/datasets/tt100k_2021/other']
    # tt100k.divide_TrainValTest(r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/train/labels', r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/train/images',sources)
    # tt100k.divide_TrainValTest(r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/test/labels', r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/test/images',sources)

    # split dfg dataset
    train_val_test_json_path_pre = r'/root/autodl-tmp/datasets/dfg'
    # train_val_test_json_path_pre = r'F:\datasets\DFG-tsd-annot-json'
    ana_txt_save_path = r'/root/autodl-tmp/datasets/dfg'
    # ana_txt_save_path = r'F:\datasets\DFG-tsd-annot-json'
    images_path=r'/root/autodl-tmp/datasets/images/JPEGImages'
    # images_path=r'F:\datasets\DFG-tsd-annot-json\images\Jpegimages'
    init_seeds()
    dfg=TT100K2COCO()
    # dfg.coco_json2yolo_txt("train",train_val_test_json_path_pre,ana_txt_save_path)
    # dfg.coco_json2yolo_txt("val",train_val_test_json_path_pre,ana_txt_save_path)
    dfg.divide_TrainValTestForDfg(r'/root/autodl-tmp/datasets/dfg/train/labels',r'/root/autodl-tmp/datasets/dfg/train/images',images_path)
    dfg.divide_TrainValTestForDfg(r'/root/autodl-tmp/datasets/dfg/val/labels',r'/root/autodl-tmp/datasets/dfg/val/images',images_path)
    # dfg.divide_TrainValTestForDfg(r'F:\datasets\DFG-tsd-annot-json\test\labels',r'F:\datasets\DFG-tsd-annot-json\test\images',r'F:\datasets\DFG-tsd-annot-json\images\Jpegimages')