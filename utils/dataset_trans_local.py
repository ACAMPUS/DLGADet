...
class TT100K2COCO:
    ...
    def class_statistics(self,flag):
        # 仅仅保留包含的图片数超过100张的类别
        ...
        num=0
        total_num=16811
        img_id_list = origin_dict['imgs'].keys()
        for img_name in img_list:
            ...
            if image_id in img_id_list:
                ...
                # if len(obj_list)!=0 and path_prefix=='other':
                #     num+=1
                # 遍历每张图片的标注信息
                for anno_dic in obj_list:
                 ...
                 print("img not in anno_dict: ",img_name)
                 print("-------------------------------")
        ...
        print("图片数为：",len(saved_images))  # 保留的100个类别
        # 保存结果
        json_name = os.path.join(parent_path, flag+'_statistics.json')
...
if __name__ == '__main__':
    tt100k = TT100K2COCO()
    # tt100k.class_statistics('train')
    # train_val_test_json_path_pre=r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/json'
    # parent_path=r''
    # ana_txt_save_path=r'/root/autodl-tmp/datasets/tt100k_2021/mytt100'
    # tt100k.original_datasets2object_datasets_re()
    # train_val_test_json_path_pre=r'D:\dataset\data\new_dataset\annotations\mytt100'
    # ana_txt_save_path=r'D:\dataset\data\new_dataset\annotations\mytt100'
    ...
    # local
    # tt100k.divide_TrainValTest(r'D:\dataset\data\my_tt100k\train\labels', r'D:\dataset\data\my_tt100k\train\images')
    # tt100k.divide_TrainValTest(r'D:\dataset\data\my_tt100k\val\labels', r'D:\dataset\data\my_tt100k\val\images')
    # tt100k.divide_TrainValTest(r'D:\dataset\data\my_tt100k\test\labels', r'D:\dataset\data\my_tt100k\test\images')
    ...
    # tt100k.divide_TrainValTest(r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/val/labels', r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/val/images',sources)
