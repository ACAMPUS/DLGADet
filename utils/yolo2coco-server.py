...
def parseXmlFilse(image_path, anno_path, save_path, json_name='train.json',classes_txt_path=None):
    ...
    json.dump(coco, open(json_path, 'w'),indent=1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-ap', '--anno-path', type=str, default=r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/train/labels', help='yolo txt path')
    parser.add_argument('-s', '--save-path', type=str, default=r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/coco/train', help='json save path')
    parser.add_argument('--image-path', default=r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/train/images')
    ...
    if len(sys.argv) > 1:
        ...
        anno_path = r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/train/labels'
        save_path = r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/coco/train'
        image_path = r'/root/autodl-tmp/datasets/tt100k_2021/mytt100/train/images'
