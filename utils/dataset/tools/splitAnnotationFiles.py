...
parser.add_argument('-percentage', metavar='splitPercentage', default=80,type=int, help='The percentage that will be put in split1.csv. The rest of the lines will be put in split2.csv.')
parser.add_argument('-path', metavar='filename.csv', type=str, default=r'D:\dataset\glare\GLARE-20221101T123242Z-001\GLARE\Images\allAnnotations.csv',help='The path to the csv-file containing the annotations.')
