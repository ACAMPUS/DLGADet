...
# 原始标签路径
originLabelsDir = 'D:/dataset/data/new_dataset/annotations/mytt100_origion/test/labels'
# 转换后的文件保存路径
saveDir = 'D:/dataset/data/new_dataset/annotations/mytt100_origion/test/labels-new.txt'
# 原始标签对应的图片路径
originImagesDir = 'D:/dataset/data/new_dataset/annotations/mytt100_origion/test/images'
