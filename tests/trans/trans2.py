...
root_path = 'D:/dataset/data/new_dataset/annotations/mytt100_origion/test'
# 用于创建训练集或验证集
phase = 'val_generate'  # 需要修正，保存后的json文件名
...
# 读取Bbox信息
with open(os.path.join(root_path, 'root','labels-new.txt')) as tr:
    annos = tr.readlines()
