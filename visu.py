...
def get_params():
    params = {
        'weight': r'D:\dataset\实验记录\38\exp40\weights\best.pt',
        'cfg': 'E:\paper\code\yolov5-6.1\models\hub\yolov5-p2-modify-decoupled-head-add-attn-use-deform-conv-add-more-reduce-one-use-c3tr.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'D:\dataset\data\new_dataset\annotations\73.jpg', 'result')